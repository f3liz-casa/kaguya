...
module Admin = {
    ...
    type postAdminAccountsCreateResponse = ComponentSchemas.Medetailed.t

    let postAdminAccountsCreateResponseSchema = ComponentSchemas.Medetailed.schema
    ...
    type postAdminAccountsFindByEmailResponse = ComponentSchemas.Userdetailed.t

    let postAdminAccountsFindByEmailResponseSchema = ComponentSchemas.Userdetailed.schema
