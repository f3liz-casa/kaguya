...
module Users = {
    ...
    let postUsersGetFollowingBirthdayUsers = (~body, ~fetch): promise<postUsersGetFollowingBirthdayUsersResponse> => {
      ...
      let validatedResponse = postUsersGetFollowingBirthdayUsersResponseSchema->S.parseOrThrow(response)
      validatedResponse
    ->Promise.resolve
      })
    }
    ...
    let postUsersGetFrequentlyRepliedUsers = (~body, ~fetch): promise<postUsersGetFrequentlyRepliedUsersResponse> => {
      ...
      let validatedResponse = postUsersGetFrequentlyRepliedUsersResponseSchema->S.parseOrThrow(response)
      validatedResponse
    ->Promise.resolve
      })
    }
    ...
    let postUsersSearchByUsernameAndHost = (~body, ~fetch): promise<postUsersSearchByUsernameAndHostResponse> => {
      ...
      let validatedResponse = postUsersSearchByUsernameAndHostResponseSchema->S.parseOrThrow(response)
      validatedResponse
    ->Promise.resolve
      })
    }
