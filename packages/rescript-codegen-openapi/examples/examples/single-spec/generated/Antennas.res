...
module Antennas = {
    ...
    type postAntennasCreateResponse = JSON.t

    let postAntennasCreateResponseSchema = S.json
    ...
    type postAntennasShowResponse = JSON.t

    let postAntennasShowResponseSchema = S.json
    ...
    type postAntennasUpdateResponse = JSON.t

    let postAntennasUpdateResponseSchema = S.json
