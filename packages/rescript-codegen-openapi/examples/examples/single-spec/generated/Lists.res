...
module Lists = {
    ...
    type postUsersListsCreateResponse = JSON.t

    let postUsersListsCreateResponseSchema = S.json
    ...
    type postUsersListsUpdateResponse = JSON.t

    let postUsersListsUpdateResponseSchema = S.json
