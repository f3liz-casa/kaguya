...
module Users = {
  ...
  let postEmailAddressAvailable = (~body, ~fetch): promise<postEmailAddressAvailableResponse> => {
    let validatedBody = postEmailAddressAvailableRequestSchema->S.parseOrThrow(body)
    ...
    fetch(
      ...
      let validatedResponse = postEmailAddressAvailableResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  let postGetAvatarDecorations = (~fetch): promise<postGetAvatarDecorationsResponse> => {
    fetch(~url="/get-avatar-decorations", ~method_="POST")->Promise.then(response => {
      let validatedResponse = postGetAvatarDecorationsResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // i/move
  let postIMove = (~body, ~fetch): promise<postIMoveResponse> => {
    let validatedBody = postIMoveRequestSchema->S.parseOrThrow(body)

    fetch(~url="/i/move", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postIMoveResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // pinned-users
  let postPinnedUsers = (~fetch): promise<postPinnedUsersResponse> => {
    fetch(~url="/pinned-users", ~method_="POST")->Promise.then(response => {
      let validatedResponse = postPinnedUsersResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // retention
  let getRetention = (~fetch): promise<getRetentionResponse> => {
    fetch(~url="/retention", ~method_="GET")->Promise.then(response => {
      let validatedResponse = getRetentionResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // retention
  let postRetention = (~fetch): promise<postRetentionResponse> => {
    fetch(~url="/retention", ~method_="POST")->Promise.then(response => {
      let validatedResponse = postRetentionResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // username/available
  let postUsernameAvailable = (~body, ~fetch): promise<postUsernameAvailableResponse> => {
    let validatedBody = postUsernameAvailableRequestSchema->S.parseOrThrow(body)
    ...
    fetch(
      ...
      let validatedResponse = postUsernameAvailableResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users
  let postUsers = (~body, ~fetch): promise<postUsersResponse> => {
    let validatedBody = postUsersRequestSchema->S.parseOrThrow(body)

    fetch(~url="/users", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postUsersResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/clips
  let postUsersClips = (~body, ~fetch): promise<postUsersClipsResponse> => {
    let validatedBody = postUsersClipsRequestSchema->S.parseOrThrow(body)

    fetch(~url="/users/clips", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postUsersClipsResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/flashs
  let postUsersFlashs = (~body, ~fetch): promise<postUsersFlashsResponse> => {
    let validatedBody = postUsersFlashsRequestSchema->S.parseOrThrow(body)

    fetch(~url="/users/flashs", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postUsersFlashsResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/followers
  let postUsersFollowers = (~body, ~fetch): promise<postUsersFollowersResponse> => {
    let validatedBody = postUsersFollowersRequestSchema->S.parseOrThrow(body)

    fetch(~url="/users/followers", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postUsersFollowersResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/following
  let postUsersFollowing = (~body, ~fetch): promise<postUsersFollowingResponse> => {
    let validatedBody = postUsersFollowingRequestSchema->S.parseOrThrow(body)

    fetch(~url="/users/following", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postUsersFollowingResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/gallery/posts
  let postUsersGalleryPosts = (~body, ~fetch): promise<postUsersGalleryPostsResponse> => {
    let validatedBody = postUsersGalleryPostsRequestSchema->S.parseOrThrow(body)
    ...
    fetch(
      ...
      let validatedResponse = postUsersGalleryPostsResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  let postUsersGetFollowingBirthdayUsers = (~body, ~fetch): promise<
    postUsersGetFollowingBirthdayUsersResponse,
  > => {
    let validatedBody = postUsersGetFollowingBirthdayUsersRequestSchema->S.parseOrThrow(body)
    ...
    fetch(
      ...
      let validatedResponse =
        postUsersGetFollowingBirthdayUsersResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  let postUsersGetFrequentlyRepliedUsers = (~body, ~fetch): promise<
    postUsersGetFrequentlyRepliedUsersResponse,
  > => {
    let validatedBody = postUsersGetFrequentlyRepliedUsersRequestSchema->S.parseOrThrow(body)
    ...
    fetch(
      ...
      let validatedResponse =
        postUsersGetFrequentlyRepliedUsersResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  let postUsersGetSecurityInfo = (~body, ~fetch): promise<postUsersGetSecurityInfoResponse> => {
    let validatedBody = postUsersGetSecurityInfoRequestSchema->S.parseOrThrow(body)
    ...
    fetch(
      ...
      let validatedResponse = postUsersGetSecurityInfoResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  let getUsersGetSkebStatus = (~body, ~fetch): promise<getUsersGetSkebStatusResponse> => {
    let validatedBody = getUsersGetSkebStatusRequestSchema->S.parseOrThrow(body)
    ...
    fetch(
      ...
      let validatedResponse = getUsersGetSkebStatusResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/get-skeb-status
  let postUsersGetSkebStatus = (~body, ~fetch): promise<postUsersGetSkebStatusResponse> => {
    let validatedBody = postUsersGetSkebStatusRequestSchema->S.parseOrThrow(body)
    ...
    fetch(
      ...
      let validatedResponse = postUsersGetSkebStatusResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/notes
  let postUsersNotes = (~body, ~fetch): promise<postUsersNotesResponse> => {
    let validatedBody = postUsersNotesRequestSchema->S.parseOrThrow(body)

    fetch(~url="/users/notes", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postUsersNotesResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/pages
  let postUsersPages = (~body, ~fetch): promise<postUsersPagesResponse> => {
    let validatedBody = postUsersPagesRequestSchema->S.parseOrThrow(body)

    fetch(~url="/users/pages", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postUsersPagesResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/reactions
  let postUsersReactions = (~body, ~fetch): promise<postUsersReactionsResponse> => {
    let validatedBody = postUsersReactionsRequestSchema->S.parseOrThrow(body)

    fetch(~url="/users/reactions", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postUsersReactionsResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  let postUsersRecommendation = (~body, ~fetch): promise<postUsersRecommendationResponse> => {
    let validatedBody = postUsersRecommendationRequestSchema->S.parseOrThrow(body)
    ...
    fetch(
      ...
      let validatedResponse = postUsersRecommendationResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/relation
  let postUsersRelation = (~body, ~fetch): promise<postUsersRelationResponse> => {
    let validatedBody = postUsersRelationRequestSchema->S.parseOrThrow(body)

    fetch(~url="/users/relation", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postUsersRelationResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/report-abuse
  let postUsersReportAbuse = (~body, ~fetch): promise<postUsersReportAbuseResponse> => {
    let validatedBody = postUsersReportAbuseRequestSchema->S.parseOrThrow(body)
  ...
  // users/search
  let postUsersSearch = (~body, ~fetch): promise<postUsersSearchResponse> => {
    let validatedBody = postUsersSearchRequestSchema->S.parseOrThrow(body)

    fetch(~url="/users/search", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postUsersSearchResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  let postUsersSearchByUsernameAndHost = (~body, ~fetch): promise<
    postUsersSearchByUsernameAndHostResponse,
  > => {
    let validatedBody = postUsersSearchByUsernameAndHostRequestSchema->S.parseOrThrow(body)
    ...
    fetch(
      ...
      let validatedResponse =
        postUsersSearchByUsernameAndHostResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/show
  let postUsersShow = (~body, ~fetch): promise<postUsersShowResponse> => {
    let validatedBody = postUsersShowRequestSchema->S.parseOrThrow(body)

    fetch(~url="/users/show", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postUsersShowResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
  ...
  // users/stats
  let postUsersStats = (~body, ~fetch): promise<postUsersStatsResponse> => {
    let validatedBody = postUsersStatsRequestSchema->S.parseOrThrow(body)

    fetch(~url="/users/stats", ~method_="POST", ~body=validatedBody)->Promise.then(response => {
      let validatedResponse = postUsersStatsResponseSchema->S.parseOrThrow(response)
      validatedResponse->Promise.resolve
    })
  }
}
