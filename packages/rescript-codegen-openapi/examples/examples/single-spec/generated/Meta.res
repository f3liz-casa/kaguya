...
module Meta = {
    ...
    type postAnnouncementResponse = JSON.t

    let postAnnouncementResponseSchema = S.json
    ...
    type postAnnouncementsShowResponse = JSON.t

    let postAnnouncementsShowResponseSchema = S.json
    ...
    type getEmojiResponse = JSON.t

    let getEmojiResponseSchema = S.json
    ...
    type postEmojiResponse = JSON.t

    let postEmojiResponseSchema = S.json
    ...
    type postInviteCreateResponse = JSON.t

    let postInviteCreateResponseSchema = S.json
