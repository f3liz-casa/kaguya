...
module Account = {
    ...
    type postBlockingCreateResponse = JSON.t

    let postBlockingCreateResponseSchema = S.json
    ...
    type postBlockingDeleteResponse = JSON.t

    let postBlockingDeleteResponseSchema = S.json
    ...
    type postIResponse = JSON.t

    let postIResponseSchema = S.json
    ...
    type postIPinResponse = JSON.t

    let postIPinResponseSchema = S.json
    ...
    type postIUnpinResponse = JSON.t

    let postIUnpinResponseSchema = S.json
    ...
    type postIUpdateResponse = JSON.t

    let postIUpdateResponseSchema = S.json
