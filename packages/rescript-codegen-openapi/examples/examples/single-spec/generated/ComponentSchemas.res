...
module Abuseuserreport = {
  ...
  resolved: bool,
  reporterid: string,
  reporter: ComponentSchemas.Userdetailed.t,
  targetuserid: string,
  targetuser: ComponentSchemas.Userdetailed.t,
  assigneeid: JSON.t,
  ...
  let schema = S.object(s => {
    ...
    reporter: s.field("reporter", ComponentSchemas.Userdetailed.schema),
    targetuserid: s.field("targetUserId", S.string),
    targetuser: s.field("targetUser", ComponentSchemas.Userdetailed.schema),
...
module Blocking = {
  ...
  createdat: string,
  blockeeid: string,
  blockee: ComponentSchemas.Userdetailednotme.t,
}
  ...
  let schema = S.object(s => {
    ...
    blockee: s.field("blockee", ComponentSchemas.Userdetailednotme.schema),
  })
}
...
module Channel = {
  ...
  pinnednotes: option<array<ComponentSchemas.Note.t>>,
}
  ...
  let schema = S.object(s => {
    ...
    pinnednotes: s.fieldOr("pinnedNotes", S.nullableAsOption(S.array(ComponentSchemas.Note.schema)), None),
  })
}
...
module Chatmessage = {
  ...
  createdat: string,
  fromuserid: string,
  fromuser: ComponentSchemas.Userlite.t,
  ...
  let schema = S.object(s => {
    ...
    fromuser: s.field("fromUser", ComponentSchemas.Userlite.schema),
...
module Chatroom = {
  ...
  createdat: string,
  ownerid: string,
  owner: ComponentSchemas.Userlite.t,
  name: string,
  description: string,
  ismuted: option<bool>,
}
  ...
  let schema = S.object(s => {
    ...
    owner: s.field("owner", ComponentSchemas.Userlite.schema),
    name: s.field("name", S.string),
...
module Chatroominvitation = {
  ...
  createdat: string,
  userid: string,
  user: ComponentSchemas.Userlite.t,
  roomid: string,
  room: ComponentSchemas.Chatroom.t,
}
  ...
  let schema = S.object(s => {
    ...
    user: s.field("user", ComponentSchemas.Userlite.schema),
    roomid: s.field("roomId", S.string),
    room: s.field("room", ComponentSchemas.Chatroom.schema),
  })
}
...
module Flashlike = {
  type t = {
  id: string,
  flash: ComponentSchemas.Flash.t,
}
  
  let schema = S.object(s => {
    id: s.field("id", S.string),
    flash: s.field("flash", ComponentSchemas.Flash.schema),
  })
}
...
module Followrequest = {
  type t = {
  id: string,
  follower: ComponentSchemas.Userlite.t,
  followee: ComponentSchemas.Userlite.t,
}
  
  let schema = S.object(s => {
    id: s.field("id", S.string),
    follower: s.field("follower", ComponentSchemas.Userlite.schema),
    followee: s.field("followee", ComponentSchemas.Userlite.schema),
  })
}
...
module Gallerylike = {
  type t = {
  id: string,
  post: ComponentSchemas.Gallerypost.t,
}
  
  let schema = S.object(s => {
    id: s.field("id", S.string),
    post: s.field("post", ComponentSchemas.Gallerypost.schema),
  })
}
...
module Gallerypost = {
  ...
  files: option<array<ComponentSchemas.Drivefile.t>>,
  ...
  let schema = S.object(s => {
    ...
    files: s.fieldOr("files", S.nullableAsOption(S.array(ComponentSchemas.Drivefile.schema)), None),
...
module Medetailedonly = {
  ...
  unreadannouncements: array<ComponentSchemas.Announcement.t>,
  ...
  let schema = S.object(s => {
    ...
    unreadannouncements: s.field("unreadAnnouncements", S.array(ComponentSchemas.Announcement.schema)),
...
module Muting = {
  ...
  expiresat: JSON.t,
  muteeid: string,
  mutee: ComponentSchemas.Userdetailednotme.t,
}
  ...
  let schema = S.object(s => {
    ...
    mutee: s.field("mutee", ComponentSchemas.Userdetailednotme.schema),
  })
}
...
module Notefavorite = {
  ...
  let schema = S.object(s => {
    id: s.field("id", S.string),
    createdat: s.field("createdAt", S.string),
    note: s.field("note", ComponentSchemas.Note.schema),
...
module Page = {
  ...
  userid: string,
  user: ComponentSchemas.Userlite.t,
  content: array<ComponentSchemas.Pageblock.t>,
  ...
  attachedfiles: array<ComponentSchemas.Drivefile.t>,
  likedcount: float,
  isliked: option<bool>,
  visibility: string,
}
  ...
  let schema = S.object(s => {
    ...
    userid: s.field("userId", S.string),
    user: s.field("user", ComponentSchemas.Userlite.schema),
    content: s.field("content", S.array(ComponentSchemas.Pageblock.schema)),
    ...
    attachedfiles: s.field("attachedFiles", S.array(ComponentSchemas.Drivefile.schema)),
    likedcount: s.field("likedCount", S.float),
    isliked: s.fieldOr("isLiked", S.nullableAsOption(S.bool), None),
    visibility: s.field("visibility", S.string),
  })
...
module Pagelike = {
  type t = {
  id: string,
  page: ComponentSchemas.Page.t,
}
  
  let schema = S.object(s => {
    id: s.field("id", S.string),
    page: s.field("page", ComponentSchemas.Page.schema),
  })
}
...
module Reversigamedetailed = {
  ...
  user1id: string,
  user2id: string,
  user1: ComponentSchemas.Userlite.t,
  user2: ComponentSchemas.Userlite.t,
  winnerid: JSON.t,
  winner: JSON.t,
  ...
  let schema = S.object(s => {
    ...
    user1: s.field("user1", ComponentSchemas.Userlite.schema),
    user2: s.field("user2", ComponentSchemas.Userlite.schema),
...
module Rolecondformulalogics = {
  ...
  id: string,
  @as("type") type_: string,
  values: array<ComponentSchemas.Rolecondformulavalue.t>,
}
  
  let schema = S.object(s => {
    id: s.field("id", S.string),
    type_: s.field("type", S.string),
    values: s.field("values", S.array(ComponentSchemas.Rolecondformulavalue.schema)),
  })
}
...
module Rolecondformulavaluenot = {
  ...
  id: string,
  @as("type") type_: string,
  value: ComponentSchemas.Rolecondformulavalue.t,
}
  
  let schema = S.object(s => {
    id: s.field("id", S.string),
    type_: s.field("type", S.string),
    value: s.field("value", ComponentSchemas.Rolecondformulavalue.schema),
  })
}
...
module User = {
  ...
  let schema = S.union([ComponentSchemas.Userlite.schema, ComponentSchemas.Userdetailed.schema])
}
...
module Useraccountmovelog = {
  ...
  createdat: string,
  movedtoid: string,
  movedto: ComponentSchemas.Userdetailed.t,
  movedfromid: string,
  movedfrom: ComponentSchemas.Userdetailed.t,
}
  ...
  let schema = S.object(s => {
    ...
    movedto: s.field("movedTo", ComponentSchemas.Userdetailed.schema),
    movedfromid: s.field("movedFromId", S.string),
    movedfrom: s.field("movedFrom", ComponentSchemas.Userdetailed.schema),
  })
}
...
module Userdetailed = {
  ...
  let schema = S.union([ComponentSchemas.Userdetailednotme.schema, ComponentSchemas.Medetailed.schema])
}
...
module Userdetailednotmeonly = {
  ...
  notescount: float,
  pinnednoteids: array<string>,
  pinnednotes: array<ComponentSchemas.Note.t>,
  pinnedpageid: JSON.t,
  pinnedpage: JSON.t,
  ...
  chatscope: string,
  canchat: bool,
  roles: array<ComponentSchemas.Rolelite.t>,
  ...
  let schema = S.object(s => {
    ...
    notescount: s.field("notesCount", S.float),
    pinnednoteids: s.field("pinnedNoteIds", S.array(S.string)),
    pinnednotes: s.field("pinnedNotes", S.array(ComponentSchemas.Note.schema)),
    ...
    roles: s.field("roles", S.array(ComponentSchemas.Rolelite.schema)),
