...
module Channels = {
    ...
    type postChannelsCreateResponse = JSON.t

    let postChannelsCreateResponseSchema = S.json
    ...
    type postChannelsShowResponse = JSON.t

    let postChannelsShowResponseSchema = S.json
    ...
    type postChannelsUpdateResponse = JSON.t

    let postChannelsUpdateResponseSchema = S.json
