...
function getOperations(path, pathItem) {
  let operations = [];
  Stdlib_Option.forEach(pathItem.get, op => {
    operations.push([
      path,
      "GET",
      op
  ...
  Stdlib_Option.forEach(pathItem.post, op => {
    operations.push([
      path,
      "POST",
      op
  ...
  Stdlib_Option.forEach(pathItem.put, op => {
    operations.push([
      path,
      "PUT",
      op
  ...
  Stdlib_Option.forEach(pathItem.patch, op => {
    operations.push([
      path,
      "PATCH",
      op
  ...
  Stdlib_Option.forEach(pathItem.delete, op => {
    operations.push([
      path,
      "DELETE",
      op
  ...
  Stdlib_Option.forEach(pathItem.head, op => {
    operations.push([
      path,
      "HEAD",
      op
  ...
  Stdlib_Option.forEach(pathItem.options, op => {
    operations.push([
      path,
      "OPTIONS",
      op
